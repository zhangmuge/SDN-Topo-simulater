          ...
          <v-layout wrap>
            ...
            <v-flex xs12>
              <v-text-field
                ...
                label="监听端口号(Base Listening Port)"
                max="65535"
                min="1"
                type="number"
              />
            ...
            <v-flex xs12>
              <ThreeStateCheckbox
                ...
                label="自动分配MAC地址(Automatic MAC Addresses)"
              />
            </v-flex>
            <v-flex xs12>
              <ThreeStateCheckbox
...
import { ipWithMask, port } from "@/utils/validation/rules";
